...
import glaze.api.std.list;
import glaze.api.std.map;
import glaze.api.std.optional;
import glaze.api.std.shared_ptr;
import glaze.api.std.string;
import glaze.api.std.tuple;
import glaze.api.std.unique_ptr;
...
#include "glaze/api/std/deque.cppm"
#include "glaze/api/std/functional.cppm"
#include "glaze/api/std/list.cppm"
#include "glaze/api/std/map.cppm"
#include "glaze/api/std/optional.cppm"
#include "glaze/api/std/shared_ptr.cppm"
#include "glaze/api/std/string.cppm"
#include "glaze/api/std/tuple.cppm"
#include "glaze/api/std/unique_ptr.cppm"
#include "glaze/api/std/unordered_map.cppm"
#include "glaze/api/std/variant.cppm"
#include "glaze/api/std/vector.cppm"
#include "glaze/api/tuplet.cppm"
#include "glaze/api/type_support.cppm"
